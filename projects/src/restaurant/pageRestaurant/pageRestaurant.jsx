                ...
                <div className="cuisine-res">
                    ...
                    <div className="content-cuisine-res">
                        ...
                        <div className="cuisine-checkbox-country">
                            {/* <input className="checkbox-cuisine" id="American" type="checkbox" value='american' onChange={(e)=>handleClickCuisine(e)} />
                            <input className="checkbox-cuisine" id="Chinese" type="checkbox" value='chinese' onChange={(e)=>handleClickCuisine(e)}/>
                            <input className="checkbox-cuisine" id="Italian" type="checkbox" value='italian' onChange={(e)=>handleClickCuisine(e)}/> */}
